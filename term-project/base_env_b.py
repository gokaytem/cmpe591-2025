...
class BaseEnvB:
    ...
    def _create_scene(self):
        return create_tabletop_scene(
            object_color=[0.2, 1.0, 0.2, 1.0],         # green
            container_color=[0.2, 0.2, 1.0, 1.0],      # blue
            pick_pos=self.pick_pos,
            place_pos=self.place_pos,
            table_color=[0.9, 0.9, 0.9, 1.0],        # light grey
            wall_color=[0.36, 0.25, 0.20, 1.0],      # dark brown
            table_texture="image",                   # request image for table
            table_texture_path="wood.png",           # path to your image file
            floor_texture="image",                   # request image for floor
            floor_texture_path="floor.png"           # path to your floor image file
        )
